...
- Revenue decreases when discount % increases → **High discounts reduce profitability**
- Google Ads show **higher ROI**
- Festive campaigns consistently perform well → **Replicate strategy across years**
- Asia-Pacific & Middle East regions show **growth opportunities**
...
| Focus Area | Action |
|----------|--------|
| Discount Strategy | Reduce high discount ranges |
